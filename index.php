...
<div class="page-wrapper">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:48px;margin-top:20px">
        <div>
            ...
            <form method="GET" action="index.php" class="search-bar" style="max-width:500px">
    ...
    <div class="venue-grid" style="margin-top:20px">
        ...
        <div class="venue-card">
            ...
            <div style="padding:0 16px 16px">
                <a href="venue.php?id=<?= $row['id'] ?>" class="btn btn-primary" style="width:100%;display:block">View Details</a>
            </div>
        </div>
        <?php endwhile; ?>
    </div>

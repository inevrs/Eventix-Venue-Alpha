...
<div class="page-wrapper" style="max-width:1100px">
    <div style="margin-bottom: 24px;">
        <a href="index.php" class="btn btn-outline btn-sm" style="display: inline-flex; align-items: center; gap: 8px;">
    ...
    <div class="detail-layout">
        ...
        <div class="card" style="position:sticky;top:84px">
            ...
            <?php elseif ($role): ?>
                <button type="button" class="btn btn-outline" style="width:100%" disabled>Log in as customer to book</button>
            <?php else: ?>
                <!-- Not logged in, trigger auth modal -->
                <button type="button" class="btn btn-primary" style="width:100%" onclick="openAuthModal(<?= $venue['id'] ?>)">Log in to Book →</button>
            <?php endif; ?>
...
function updateTotal() {
    ...
    // Also save addons in window var so modal can grab them

...
$bookings = mysqli_query($connect, "
    SELECT b.*, u.full_name, v.name AS venue_name, p.payment_proof, p.status AS payment_status
    FROM bookings b
                ...
                <table class="w-full text-sm text-left">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-4 border-b border-gray-100 text-pink-dark text-xs uppercase tracking-wider font-semibold bg-gray-50">Payment Proof</th>
